...
var name = propmpt("please state your name");
...
//.   Score is 45, validate that 45 is greater or equal to the value that was entered in the input prompt, else provide an alternative answer
 var yourscore = prompt("What is your score?");
  var score = 45;
  if(yourscsore > score){
    console.log("Your score is greater");
  } else if (score > yourscore){
    console.log("Score is greater than your score");
  } else {
...
//-------------------------------------------------//
 ...
 var vacation = ["Friday Harbor","Finger Lakes","Colorado","Geneva","Argentina"];
